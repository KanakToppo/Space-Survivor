;(function(exports) {
  function Asteroid(game, center, size) {
    ...
    this.speed = (4 - size) / 4;    // Inversely proportional to size
	...
	//break sound
	this.breakSound = new Audio('./res/asteroidBreak.mp3');
	this.breakSound.playbackRate = this.speed * 4;
  }
  ...
  Asteroid.prototype = {
    ...
    //Creates three asteroids out of destroyed one
    spawn: function() {
      for (var i = 0; i < 3; i++) {
